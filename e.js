...
function e(deliveries,matches2015){
    ...
    function e(bowlerstats,bowlerNames){
        const tem={};
    ...
    const bowlerstates=Object.values(Obj);
    const bowlerName=Object.keys(Obj);
    const economyOfBowlers=e(bowlerstates,bowlerName);
